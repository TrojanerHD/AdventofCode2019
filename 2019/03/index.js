...
function main (data) {
  ...
  return [{
    message: 'The next intersection with the smallest Manhattan distance is',
    value: minimumDistance
  }, {
    message: 'In total, it requires the following count of steps to get to the central point',
    value: bestSteps.first + bestSteps.second
  }]
}
